...
;汎用キャラ定義
;★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
[chara_new name="narration" storage="test.png" jname="ナレーション" width="0"]
[chara_new name="narration" storage="test.png" jname="Narration" width="0" cond="f.en == true"]

[chara_new name="everyone" storage="test.png" jname="一同" width="0"]
[chara_new name="everyone" storage="test.png" jname="Everyone" width="0" cond="f.en == true"]
